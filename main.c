...
void trip_file_swap(FILE *fp, int idx1, int idx2) {
  ...
  // binária idx1 e idx2 são índices de Tripulantes no ficheiro esta função
  // troca os dois tripulantes
}
...
int main() {
  ...
  printf("%d %d %d %d", todas_func_mil.cont_funcoes,
         todos_tipos_missoes.cont_tipos_missao, todas_as_missoes.cont_missoes,
         todos_os_militares.cont_militares);
  // teste dados

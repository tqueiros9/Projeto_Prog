...
// funcao utilizada para gravar as linhas de dados provenientes da funcao que
// abre o ficheiro dos militares
void adicionar_dados_militares(char linha[], Total_militares *lista_mil_total,
  ...
  while (temp != NULL) {
    ...
    // ao dividir a linha sabe-se automaticamente cada parte da linha
    // NIP;NOME;etc
    switch (cont) {
    case 0:
    ...
    case 4:
      if (help != 0) {
        ...
        lista_mil_total->total_tripulantes[lista_mil_total->cont_militares]
            .oper = data1 + data2 * 100 + data3 * 10000;
...
// recebe lista de militares, o seu estado 0 = OP e 1 = INOP, e a funcao e um
// inteiro
void imprimir_lista_militares(Total_militares *lista_militares, int estado,
  ...
  // imprime o nome e o nip caso cumpra os requisitos ou se for -1, para ignorar
  // esse requisito
